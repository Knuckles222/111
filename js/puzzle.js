...
const PUZZLE = (() => {
  ...
  function _offsetX() { return (VIRTUAL_WIDTH  - GRID_W - HUD_WIDTH) / 2; }
  function _offsetY() { return (VIRTUAL_HEIGHT - GRID_H) / 2; }
  ...
  function _drawOverlay(title, sub, col) {
    ...
    textSize(28);
    textAlign(CENTER, CENTER);
    text(title, VIRTUAL_WIDTH / 2, VIRTUAL_HEIGHT / 2 - 20);

    fill(200);
    textSize(13);
    text(sub, VIRTUAL_WIDTH / 2, VIRTUAL_HEIGHT / 2 + 20);
  }
